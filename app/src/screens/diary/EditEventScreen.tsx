...
export function EditEventScreen({ navigation, route }: DiaryStackScreenProps<'EditEvent'>) {
  ...
  useEffect(() => {
    ...
    setGroupTitle(event.group.title);
    setGroupAvatarUrl(event.group.avatarUrl);
